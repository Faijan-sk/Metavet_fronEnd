          ...
          {userType === 3 && (
            <div className="space-y-2">
              ...
              <div className="relative">
                <button
                  type="button"
                  className={`w-full px-3 py-2.5 border-2 rounded-lg text-left text-sm hover:border-primary/70 focus:border-primary focus:outline-none transition-all duration-200 ${
                    serviceTypeError
                ...
                >
                  <span
                    className={
                      selectedServiceType ? "text-gray-900" : "text-gray-500"
                    }
                  >
