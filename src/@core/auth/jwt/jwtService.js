...
export default class JwtService {
  ...
  updatePet(petId, ...payload) {
    ...
    return axios.put(
      `${this.jwtConfig.updatePetEndPoint}${petId}`,
      ...payload,
      {
        headers: {
          Authorization: `Bearer ${localStorage.getItem(this.jwtConfig.storageTokenKeyName)}`,
  ...
  getDoctorDayId(doctorId, day) {
    ...
    return axios.get(
      `${this.jwtConfig.fetDoctorDayIdByDoctorAndDay}/${doctorId}/day/${day}/id`,
    );
  }
  ...
  metavetToWalkerKyc(formData) {
    if (!(formData instanceof FormData)) {
      console.warn(
        "metavetToWalkerKyc expects a FormData instance - sending as-is",
      );
    }
  ...
  metavetToGroomerKyc(formData) {
    if (!(formData instanceof FormData)) {
      console.warn(
        "metavetToGroomerKyc expects a FormData instance - sending as-is",
      );
    }
    // No Content-Type header here; interceptor handles FormData case
  ...
  metavetToBehaviouristKyc(formData) {
    if (!(formData instanceof FormData)) {
      console.warn(
        "metavetToBehaviourist expects a FormData instance - sending as-is",
      );
    }
    // No Content-Type header here; interceptor handles FormData case
    return axios.post(
      this.jwtConfig.metavetToBehaviouristKycEndPoint,
      formData,
    );
  }
  ...
  walkerToClientKyc(formData) {
    if (!(formData instanceof FormData)) {
      console.warn(
        "walker to client expects a FormData instance - sending as-is",
      );
    }
    // No Content-Type header here; interceptor handles FormData case
  ...
  getAvailableSlotByDoctortoDate(date) {
    return axios.get(
      this.jwtConfig.getDoctorSlotByDate.replace("{date}", date),
    );
  }
  ...
  getDoctorDaysFromDistance(doctorId) {
    return axios.get(
      this.jwtConfig.getDoctorDaysFromDistance.replace("{doctorId}", doctorId),
    );
  }
  getSlotByDoctor(doctorId, doctorDayId, date) {
    return axios.get(
      this.jwtConfig.getSlotByDoctorEndpoint
        .replace("{date}", date)
  ...
  veriFyAppointmentPayment(SessionId, UserTypeEndpoint) {
    return axios.get(
      this.jwtConfig.verifyAppointmentPaymentEndpoint
        .replace("{UserTypeEndpoint}", UserTypeEndpoint)
  ...
  verifyPaymentforAll(SessionId) {
    return axios.get(
      this.jwtConfig.verifyPaymentCommonEndpoint.replace(
        "{sessionId}",
        SessionId,
      ),
    );
  ...
  getWalkerAvailableDays(walkerUid) {
    return axios.get(
      this.jwtConfig.getWalkerDaysEndPoint.replace("{Uid}", walkerUid),
    );
  }
  ...
  getBehaviouristAvailableDay(uid) {
    return axios.get(
      this.jwtConfig.getAvailableBehaviouristDay.replace("{Uid}", uid),
    );
  }
  ...
  getAvailableGroomerDays(groomerUid) {
    return axios.get(
      this.jwtConfig.getGroomerAvailableDays.replace(
        "{groomerUid}",
        groomerUid,
      ),
    );
  ...
  getGroomerAvailableSlotServices(date, groomerUid) {
    return axios.get(
      this.jwtConfig.GetAvailableSlotAndService.replace("{date}", date).replace(
        "{GroomerUid}",
        groomerUid,
      ),
    );
  ...
  BookWalkerAppointment(payload) {
    return axios.post(this.jwtConfig.bookWalkerAppointment, payload);
  }
  ...
  getGroomerBookedAppointment() {
    return axios.get(this.jwtConfig.getGroomerBookedAppointment);
  }

  BookGroomerAppointment(payload) {
    return axios.post(this.jwtConfig.bookGroomerAppointment, payload);
  }
