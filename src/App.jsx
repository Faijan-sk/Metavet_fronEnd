...
import BehaviouristAppointmentBooking from "./views/pages/serviceProvider/petBehaviourist/BookingPage";
import GroomerBookingPage from "./views/pages/serviceProvider/petGroomer/BookingPage";
const ViewProfile4 = lazy(() => import("./views/pages/viewprofile4"));

// ======================context import
import WalkerProvider from "./context/WalkerAppointmentContext";
import BehaviouristProvider from "./context/BehaviouristAppointmentContext";
import GroomerProvider from "./context/GroomerAppointmentContext";
const App = () => {
            ...
            <BehaviouristProvider>
              <GroomerProvider>
                ...
                <Suspense fallback={<div>Loading...</div>}>
                  <Routes>
                    ...
                    <Route path="/" element={<Layout />}>
                      ...
                      />
                      <Route
                        path="/behaviourist-kyc"
                        element={<Behaviourist />}
                      />
                      <Route
                ...
                /> */}
                      ...
                      <Route
                        path="/behaviourist-appointment"
                        element={<BehaviouristAppointmentBooking />}
                      />

                      <Route
                        path="/groomer-appoinment"
                        element={<GroomerBookingPage />}
                      />
                    </Route>
                  </Routes>
                </Suspense>
